...
import GetAadToken from './components/GetAadToken';
import { IGetAadTokenProps } from './components/IGetAadTokenProps';
import { AadTokenProvider } from '@microsoft/sp-http';
import { ClientMode } from "./components/ClientMode";

export interface IGetAadTokenWebPartProps {
  description: string;
  clientMode: ClientMode;
}

export default class GetAadTokenWebPart extends BaseClientSideWebPart<IGetAadTokenWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public async render(): Promise<void> {
    const tokenId = 'https://graph.microsoft.com';
    ...
    await this.context.aadTokenProviderFactory.getTokenProvider()
      ...
      .then((accessToken: string): void => {
        ...
        const element: React.ReactElement<IGetAadTokenProps> = React.createElement(
          GetAadToken,
          {
